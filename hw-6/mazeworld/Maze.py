    ...
    def create_render_list(self):
        if len(self.blindstate) == 0:
            ...
            for index in range(0, len(self.robotloc), 2):
                ...
                cell_char = renderlist[self.index(x,y)]
                if cell_char == 'b':
                    colored_robot = "\033[1;30;44m %s\033[1;30;0m" % robotchar(robot_number)
                elif cell_char == 'g':
                    colored_robot = "\033[1;30;42m %s\033[1;30;0m"% robotchar(robot_number)
                elif cell_char == 'y':
                    colored_robot = "\033[1;30;43m %s\033[1;30;0m"% robotchar(robot_number)
                elif cell_char == 'r':
                    colored_robot = "\033[1;30;41m %s\033[1;30;0m" % robotchar(robot_number)


                renderlist[self.index(x, y)] = colored_robot
                robot_number += 1
    ...
    def __str__(self):
        ...
        for y in range(self.height - 1, -1, -1):
            for x in range(self.width):
                unformatted_char = renderlist[self.index(x, y)]
                if unformatted_char == 'b':
                    s += "\033[1;30;44m .\033[1;30;0m"
                elif unformatted_char == 'g':
                    s += "\033[1;30;42m .\033[1;30;0m"
                elif unformatted_char == 'y':
                    s += "\033[1;30;43m .\033[1;30;0m"
                elif unformatted_char == 'r':
                    s += "\033[1;30;41m .\033[1;30;0m"
                else:
                    s += unformatted_char
